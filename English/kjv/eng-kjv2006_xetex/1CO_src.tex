...
{\MT THE FIRST EPISTLE OF PAUL THE APOSTLE TO THE CORINTHIANS
...
\par }\Chap{4}{\PP \VerseOne{1}Let a
man
so
account of
us,
...
\VS{8}Therefore let us keep the
feast,
not
with
old
...
\par }\Chap{7}{\PP \VerseOne{1}Now concerning the
things
whereof ye
wrote unto
me:
...
\par }\Chap{8}{\PP \VerseOne{1}Now as
...
will, a
dispensation
{\ADD{of the gospel}} is committed unto
me.
...
\VS{21}To them that are without
law,
as without
law, (being
not without
...
\par }\Chap{10}{\PP \VerseOne{1}Moreover,
brethren, I
would not
that
ye should be
...
\par }\Chap{13}{\PP \VerseOne{1}Though I
speak with the
tongues of
men
and of
...
\par }\Chap{14}{\PP \VerseOne{1}Follow
after
charity,
and
desire
...
speak;
but
{\ADD{they are commanded}} to be under
obedience,
as
also
saith the
...
\par }\Chap{15}{\PP \VerseOne{1}Moreover,
brethren, I
declare unto
you the
gospel
...
\par }{\SH The first
{\ADD{epistle}} to the Corinthians was written from Philippi by Stephanas, and Fortunatus, and Achaicus, and Timotheus.
\par }
